      ...
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <a href="#" onClick={(e) => { e.preventDefault(); window.scrollTo({top:0,behavior:'smooth'}) }} className="flex items-center gap-3 group">
          ...
          <div className="leading-tight">
            <span className="font-heading text-white text-3xl md:text-4xl tracking-wide block group-hover:text-brand-gold transition-colors font-bold">Isaac Yap</span>
