...
const GREETING = "I'm Bruce, Isaac's AI assistant. Looking for a website or app? Tell me about your business."
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              <div style={{
                width: 10, height: 10, borderRadius: '50%', background: '#c8a24e',
              }} />
